...
= Uninstalling =
In some cases it happens that you cannot access your admin anymore, which would prevent deactivation. The plugin is shipped with a simple method to uninstall:
