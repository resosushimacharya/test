          ...
          <td colspan="3" style="padding-top:30px;">
            <table width="504" border="0" cellspacing="0" cellpadding="0" style="width:504px;">
              <tr style="background-color:#e7edf8;">
                <td width="171" style="font-family:Arial; font-size:12px; color:#666; text-transform:uppercase; padding:12px 15px; font-weight: bold;">
                  <span style="text-transform: uppercase;">Product</span>
                </td>
                <td width="30" style="font-family:Arial; font-size:12px; color:#666; text-transform:uppercase; padding:12px 15px; font-weight: bold;">
                  <span style="text-transform: uppercase;">Qty</span>
                </td>
                <td width="158" style="font-family:Arial; font-size:12px; color:#666; text-transform:uppercase; padding:12px 15px; font-weight: bold;">
                  <span style="text-transform: uppercase;">Price</span>
                </td>
                <td width="145" style="font-family:Arial; font-size:12px; color:#666; text-transform:uppercase; padding:12px 15px; font-weight: bold;">
