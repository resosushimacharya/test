  ...
  <div class="inerblock_clernn">
    <div class="cbg_content cc-clearance-wrapper clearfix">
      ...
      <div class="col-md-12 cc-clearance-row <?php echo ($i==$lencount)?"cc-mod-bord-feat":"";?>">
        ...
        <div class="col-md-4 cc-clearance-left"> <img src="<?php echo $row['featured_image']['url'];?>"/ class="img-responsive">
          <?php if($row['sticker']){?>
          <span class="cc-clearance-overlay"><?php echo $row['sticker'];?></span>
          <?php 
}?>
        </div>
        <?php }
...
"> </iframe>
        ...
        <div class="col-md-8 cc-clearance-right">
          ...
          <?php $link=null;
                        ...
                        ?>
          <div class="nowspe nowsppe pull-right"> <a href="<?php echo $link;?>" <?php echo (strcasecmp($win, 'yes')== 0)?'target="_blank"':null;?>> <?php echo $title;?> </a> </div>
          <?php } ?>
          <?php } else 
                    {
                            $win = $row['window']; 
                            ...
                            if( $doc_url && $title ) {
                    	?>
          <div class="nowspe nowsppe pull-right"> <a href="<?php echo $doc_url; ?>" target="_blank"> <?php echo $title;?> </a> </div>
          <?php 
                            }#end-if
                        }#end-else
                    ?>
