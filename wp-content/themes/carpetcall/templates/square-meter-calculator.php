       ...
       ?>
        ...
        <div class="calculator_container" id="calculator_container">
          <div class="row single-room-sec" id="row_cal_1">
            ...
            <div class="col-md-3 ">
              <div class="form-group col-md-8"> <span class="form-control col-md-8 item_indivisual_total"> = <span id="item_total_1">-</span> SQM</span> </div>
            </div>
          </div>
        </div>
        ...
        <div class="row calc-info-cntr excess-cntr">
          ...
          <div class="col-md-2 col-total-item-section">
            <div class="form-group col-md-4 no-lr cc-me"> <span class="form-control col-result-input" id="exceess_area_percent"> </span> </div>
            <div class="form-group col-md-4 no-pl"> <span class="cc-cal-showup">%</span></div>
          </div>
        </div>
        <div class="row calc-info-cntr total-cntr">
          ...
          <div class="col-md-2 col-total-item-section">
            <div class="form-group col-md-4 no-lr cc-me"> <span class="form-control col-result-input" id="total_area"> </span> </div>
            <div class="form-group col-md-4 no-pl"> <span class="cc-cal-showup">SQM</span></div>
          </div>
        </div>
        <div class="row calc-info-cntr package-cntr">
          ...
          <div class="col-md-2 col-total-item-section">
            <div class="form-group col-md-4 no-lr cc-me"> <span class="form-control col-result-input" id="no_of_packs"> </span> </div>
          </div>
        </div>
        ...
        <div class="row calc-bottom-btn-cntr">
          ...
          <div class="col-md-6 no-pl">
            <button class="btn btn-default" type="button" id="confirm_calc" > Confirm </button>
          </div>
        </div>
        <div class="row">
