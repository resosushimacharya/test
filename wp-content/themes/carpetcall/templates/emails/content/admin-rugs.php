          ...
          <td width="540">
            <table width="540" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td>
                  <p>Dear Admin,</p>
                  <p>The following product enquiry was received from the website on <?php echo $date_time; ?></p>
                </td>
              </tr>
              ...
              <tr>
                <td colspan="3">
                  <table width="540" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="140" style="font-size: 12px; font-family:'Arial', sans-serif;">Rug Information:</td>
                    ...
                    <tr>
                        <td width="140" style="font-size: 12px;">Nearest Store:</td>
                          <td style="font-size: 12px; font-family:'Arial', sans-serif;"><?php echo ucwords(strtolower($data['cc_store_name']));?></td>
                      </tr>
                    <tr>
                        <td width="140" style="font-size: 12px;">Comments/enquiries:</td>
