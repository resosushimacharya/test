     <div class="footer_c">
         <div class="container"><div class="row">
            <div class="col-md-8">
            <div class="fot_logo"><img src="<?php echo get_template_directory_uri() ;?>/images/carpetcall-logo.png" alt="logo" class="img-responsive"/></div>
            
            <div class="subcat"><div class="row"><!--my style ---->
    ...
    'walker'          => new JC_Footer_Nav_Menu()
            ...
            </div></div><div class="clearfix"></div><!-- sub category listing end -->
            <div class="social">
            <ul> <li> <span class="gtku">GET TO KNOW US</span>  </li>
          ...
          <!-- <h3 class="calspl"><a href="<?php //echo get_field('telephone',89);?>"> <?php //echo get_field('telephone',89);?></a></h3> -->
