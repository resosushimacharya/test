...
add_action( 'cc_woocommerce_single_product_summary', 'cc_woocommerce_single_product_summary_function', 98, 1 );
function cc_woocommerce_single_product_summary_function($x)
{


add_action('init','cc_woocommerce_single_product_summary_remove');

}
function cc_woocommerce_single_product_summary_remove(){
